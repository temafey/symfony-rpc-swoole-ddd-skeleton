...
class DeleteMethodTest extends AbstractRpcTestCase
{
     ...
     * @group functional
     *
     * @dataProvider \Backend\Api\RpcSkeleton\Tests\DataProvider\RpcMethodDataProvider::getDeleteMethodParams()
     *
    ...
    public function requestToAddMethodShouldReturnTrueInResponse(
        ...
        foreach ($traces as $message) {
            ...
            self::assertEquals(CommandFactory::PROGRAM_READ_MODEL_DELETE_COMMAND, $message['body']['type']);
