...
class UpdateMethod implements JsonRpcMethodInterface, MethodWithValidatedParamsInterface, JsonRpcMethodWithDocInterface
{
    ...
    /**
     * RPC api method update new item.
     *
    ...
    public function apply(?array $paramList = null)
    {
        ...
        return $this->commandBus->handle($this->commandFactory->makeItemUpdateTaskCommand($paramList['uuid'], $itemDto));
    }
